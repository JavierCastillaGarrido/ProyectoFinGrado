...
public interface ICitasService {
	...
	public Integer insertarCitas(String fecha, ClientesEntity cliente, TatuadoresEntity tatuador,  TatuajesEntity tatuajes, Integer activo)throws ClassNotFoundException, SQLException;
